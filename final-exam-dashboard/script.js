...
const KEY = {
  ...
  36:["\\(3\\lt x\\le11\\)",["Add 10 to all three parts: \\(6\\lt2x\\le22\\).","Divide all three parts by 2."]],
  ...
  63:["\\((5,0)\\)",["For an x-intercept, set \\(y=0\\).","Solve for x, then write the intercept as \\((5,0)\\)."]],
